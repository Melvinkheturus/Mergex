...
export default function Footer() {
    ...
    return (
        <>
            {/* Footer */}
            <footer className="bg-black pt-8 lg:pt-16 pb-6 lg:pb-10 relative overflow-hidden">
                ...
                <div className="max-w-7xl xl:max-w-[90rem] 2xl:max-w-[100rem] mx-auto px-4 md:px-10 lg:px-16 xl:px-20 relative z-20">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12 xl:gap-16 mb-4 lg:mb-6 mt-12 lg:mt-16">
                        ...
                        >
                            ...
                            <motion.p variants={fadeInUp} className="text-sm md:text-lg text-gray-300 font-body leading-relaxed mb-4 max-w-sm">
                                one system. zero friction
                            </motion.p>

                            {/* Social Icons - Moves to bottom on mobile! */}
                            <motion.div
                                variants={staggerContainer}
                                className="hidden md:flex gap-4 overflow-x-auto hide-scrollbar"
                        ...
                        {/* Menu Group */}
                        <motion.div
                            className="md:col-span-8 md:col-start-5 lg:col-span-7 lg:col-start-6 xl:col-span-8 xl:col-start-5 grid grid-cols-2 lg:flex md:flex-row justify-end gap-x-4 gap-y-8 md:gap-16 lg:gap-24 xl:gap-32 md:pr-8 lg:pr-12 xl:pr-16"
                            initial="hidden"
                            whileInView="visible"
                            viewport={{ once: true }}
                            variants={staggerContainer}
                        >
                            ...
                            >
                                <h4 className="font-[family-name:var(--font-playfair)] font-semibold mb-3 lg:mb-4 text-white text-base lg:text-lg tracking-wide" style={{ textShadow: '0 4px 8px rgba(0,0,0,0.4)' }}>Solutions</h4>
                                <ul className="space-y-2 lg:space-y-4 text-xs lg:text-sm font-body">
                            ...
                            <motion.div
                                ...
                                variants={menuStaggerContainer}
                            >
                                <h4 className="font-[family-name:var(--font-playfair)] font-semibold mb-3 lg:mb-4 text-white text-base lg:text-lg tracking-wide" style={{ textShadow: '0 4px 8px rgba(0,0,0,0.4)' }}>Insights</h4>
                                <ul className="space-y-2 lg:space-y-4 text-xs lg:text-sm font-body">
                            ...
                            <motion.div
                                ...
                                variants={menuStaggerContainer}
                            >
                                <h4 className="font-[family-name:var(--font-playfair)] font-semibold mb-3 lg:mb-4 text-white text-base lg:text-lg tracking-wide" style={{ textShadow: '0 4px 8px rgba(0,0,0,0.4)' }}>Company</h4>
                                <ul className="space-y-2 lg:space-y-4 text-xs lg:text-sm font-body">
                ...
                <div className="max-w-7xl xl:max-w-[90rem] 2xl:max-w-[100rem] mx-auto px-4 md:px-10 lg:px-16 xl:px-20 relative z-20">
                    ...
                    {/* Mobile Socials Block - Moved outside the conditional to show on all pages */}
                    <div className="flex flex-col items-center justify-center gap-6 mt-6 mb-8 w-full md:hidden">
                        <motion.div
                            variants={staggerContainer}
                            initial="hidden"
                            whileInView="visible"
                            viewport={{ once: true }}
                            className="flex gap-3 justify-center flex-wrap px-2"
                        >
                            {SOCIAL_LINKS.map((link) => (
                                <motion.a
                                    variants={fadeInUp}
                    ...
                    <motion.div
                        className="pt-2 md:pt-15 pb-0 flex flex-col md:flex-row justify-between items-center gap-6 lg:gap-6 text-xs lg:text-base text-gray-400 font-body relative z-10"
                        initial="hidden"
                        whileInView="visible"
                        viewport={{ once: true }}
                        variants={fadeInUp}
                    >
                        <div className="flex flex-col md:flex-row gap-2 md:gap-4 items-center order-2 md:order-1 mt-2 md:mt-0 text-center">
