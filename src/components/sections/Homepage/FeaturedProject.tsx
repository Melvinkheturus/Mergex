...
const FeaturedProject: React.FC = () => { 
  ...
  return ( 
    <div 
      className='relative w-full min-h-fit pt-20'
      onMouseLeave={handleMouseLeave}
    >
      <SectionHeader
        title="Featured Projects"
        subtitle="Explore our handpicked selection of featured projects, showcasing our expertise and innovative solutions."
