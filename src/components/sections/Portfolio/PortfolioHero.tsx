  ...
  return (
    ...
    >
      ...
      >
          ...
          >
            Explore how Mergex helps startups and businesses grow through design, innovation, and strategy.
          </motion.p>
          
          <Link
            href="/Portfolio#projects"
            className="group rounded-xl bg-linear-to-tl from-purple-400 to-purple-600 text-white font-semibold relative overflow-hidden px-6 transition-all duration-300 hover:scale-105 hover:translate-y-[-2px] hover:shadow-lg hover:shadow-purple-500/20 py-3 px-6 inline-flex items-center justify-center"
          >
