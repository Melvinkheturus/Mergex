...
/**
 * CaseStudyCardStack — Sticky card stack animation
 * Adapted from Systems CaseStudySection for use in the main showcase.
 */
export function CaseStudyCardStack({ studies }: CaseStudyCardStackProps) {
    ...
    useEffect(() => {
        ...
        const initTimer = setTimeout(() => {
            // Clean up any existing triggers for this section
