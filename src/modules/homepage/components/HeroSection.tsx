...
export function HeroSection({ content }: HeroSectionProps) {
    const tagline = content?.heroTagline || "From Chaos to Clarity . Mergex";
    const headline = content?.heroHeadline;
    const subheadline = content?.heroSubheadline;
    const primaryCtaText = content?.heroCta?.text || "Explore Systems";
    const primaryCtaLink = content?.heroCta?.link || "/systems";
    const secondaryCtaText = content?.heroSecondaryCtaText || "Discover Labs";
    const secondaryCtaLink = content?.heroSecondaryCtaLink || "/labs";
                ...
                <div className="container mx-auto px-6 md:px-12 lg:px-16 max-w-[1400px] flex-1 flex items-center justify-center">
                    <div className="flex flex-col items-center text-center w-full max-w-4xl mx-auto pt-12 md:pt-20 -mt-64 md:-mt-24">
                        ...
                        <h1 className="leading-[0.95] tracking-tight">
                            {headline ? (
                                <div className="mb-1 md:mb-2 text-center flex flex-col items-center">
                                    <span className="font-semibold text-[clamp(2.5rem,6vw,5rem)] text-black whitespace-pre-line">
                                        {headline}
                                    </span>
                                </div>
                            ) : (
                ...
                <div className="container mx-auto px-6 md:px-12 lg:px-16 max-w-[1400px] pb-8 md:pb-12">
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-10 md:gap-16 w-full">
                        ...
                        <div className="hidden md:block max-w-xl text-left">
                            {subheadline ? (
                                <p className="text-base md:text-xl text-black/95 leading-relaxed font-medium mb-3 whitespace-pre-line">
                                    {subheadline}
                                </p>
                            ) : (
                                <>
                        ...
                        <div className="flex flex-col items-center md:items-end gap-6 w-full md:w-auto">
                            ...
                            <div className="md:hidden text-center max-w-lg mb-2">
                                {subheadline ? (
                                    <p className="text-sm text-black/95 leading-relaxed font-medium whitespace-pre-line">
                                        {subheadline}
                                    </p>
                                ) : (
