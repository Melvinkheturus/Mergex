...
interface CareersHeroProps {
    content?: typeof CAREERS_HERO;
}

export function CareersHero({ content }: CareersHeroProps = {}) {
    const data = content || CAREERS_HERO;
    const headline = data.headline || CAREERS_HERO.headline;
    const subheadline = data.subheadline || CAREERS_HERO.subheadline;
    const primaryCTA = data.primaryCTA || CAREERS_HERO.primaryCTA;
    const secondaryCTA = data.secondaryCTA || CAREERS_HERO.secondaryCTA;
    return (
