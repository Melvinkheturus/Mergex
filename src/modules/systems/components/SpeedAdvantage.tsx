...
interface SpeedAdvantageProps {
    content?: typeof SPEED_ADVANTAGE;
}
 ...
 */
export function SpeedAdvantage({ content }: SpeedAdvantageProps = {}) {
    const data = content ?? SPEED_ADVANTAGE;
    const headline = data.headline || SPEED_ADVANTAGE.headline;
    const subheadline = data.subheadline || SPEED_ADVANTAGE.subheadline;
    const howWeDoIt = data.howWeDoIt?.length ? data.howWeDoIt : SPEED_ADVANTAGE.howWeDoIt;
    return (
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-16">
                ...
                <div className="mb-16 lg:mb-24">
                    ...
                    <div className="max-w-5xl animate-fadeIn" style={{ animationDelay: '0.1s' }}>
                        <h2 className="text-5xl md:text-7xl lg:text-8xl font-bold leading-[0.95] tracking-tighter mb-8 whitespace-pre-line"
                    ...
                    <div className="inline-flex items-center gap-4 bg-gradient-to-r from-[#978aff]/10 via-[#ff79c6]/10 to-[#bd93f9]/10 
                        ...
                        <div className="text-center">
                            ...
                            <div className="text-[#978aff] text-xs font-bold uppercase tracking-wider mt-1 whitespace-pre-line"
                                style={{ fontFamily: "var(--font-playfair)" }}>
                                {data.comparison?.systems || SPEED_ADVANTAGE.comparison.systems}
                            </div>
                        </div>
                        <div className="h-12 w-[1px] bg-gradient-to-b from-transparent via-[#978aff]/50 to-transparent" />
                        <div className="text-white/90 text-sm leading-tight max-w-[200px] whitespace-pre-line"
                            style={{ fontFamily: "var(--font-manrope)" }}>
                            <span className="font-bold">Traditional</span><br />
                            {data.comparison?.traditional || SPEED_ADVANTAGE.comparison.traditional}
                        </div>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                        ...
                        <div className="lg:col-span-7 group relative overflow-hidden rounded-3xl 
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-gray-400 text-base lg:text-lg leading-relaxed whitespace-pre-line"
                                    style={{ fontFamily: "var(--font-manrope)" }}>
                                    {howWeDoIt[0] || 'Modern tech stacks with zero legacy baggage'}
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="lg:col-span-5 group relative overflow-hidden rounded-3xl 
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-gray-400 text-base leading-relaxed whitespace-pre-line"
                                    style={{ fontFamily: "var(--font-manrope)" }}>
                                    {howWeDoIt[1] || 'Pre-built modular component libraries'}
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="lg:col-span-5 group relative overflow-hidden rounded-3xl 
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-gray-400 text-base leading-relaxed whitespace-pre-line"
                                    style={{ fontFamily: "var(--font-manrope)" }}>
                                    {howWeDoIt[2] || 'Iterative delivery: ship → learn → refine → repeat'}
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="lg:col-span-7 group relative overflow-hidden rounded-3xl 
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-gray-400 text-base lg:text-lg leading-relaxed whitespace-pre-line"
                                    style={{ fontFamily: "var(--font-manrope)" }}>
                                    {howWeDoIt[3] || 'Small, focused teams. No bureaucracy. No wasted meetings.'}
                                </p>
                            </div>
                        </div>
                    </div>
