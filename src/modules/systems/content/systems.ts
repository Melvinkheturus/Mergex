...
export const WHAT_WE_SOLVE = {
    ...
    proofCards: [
        ...
        {
            type: 'metric',
            value: 'Structured, Not Scattered.',
            label: 'Unified Architecture',
            description: 'No juggling multiple agencies. No disconnected tools. No chaos. Strategy, branding, automation, AI, and technology unified under one architecture.',
            dark: false,
        },
        {
            type: 'metric',
...
export const OUR_SOLUTIONS = {
    ...
    subheadline: 'Most businesses need all of this. Most businesses are paying five different vendors to get it. You don’t have to. Outcome-focused, not feature-dumping.',
    pillars: [
        {
            navLabel: 'Build.',
            title: 'Software Development',
            description: 'The digital products your business runs on. Stop rebuilding the same thing twice. We build robust technical foundations that power your business from web apps to technical systems, engineered for scale and longevity.',
            capabilities: [
                'Websites',
                'Applications',
                'Mobile Apps',
            ...
            outcomes: [
                ...
                'Maintainable, modern tech',
            ],
        },
        {
            navLabel: 'Automate.',
            title: 'AI & Automation',
            description: 'Less manual work. More business momentum. Your team is doing work a system should handle. Eliminate repetitive work and connect your stack with intelligent workflows that save hours daily.',
            capabilities: [
        ...
        },
        {
            ...
            description: 'The identity that makes you instantly recognisable and trusted. Stop looking like everyone else in your market. We build cohesive brand systems that resonate and differentiate.',
            capabilities: [
                'Logo & Brand Identity',
                'UI/UX Design',
                'Design Systems',
        ...
        },
        {
            ...
            description: 'The systems that turn traffic into revenue, reliably. Traffic without conversion is just expensive noise. Marketing infrastructure that runs on autopilot to attract, convert, and retain customers predictably.',
            capabilities: [
                'Advertising',
        ...
        },
        {
            ...
            description: 'This is where Mergex becomes a business architect - not just a vendor. This is where most agencies stop. We don’t. We engineer the full growth infrastructure behind modern businesses.',
            capabilities: [
                'Business Audit',
                'Growth Strategy',
                'Revenue System Design',
                'Full Business System Design',
                'Strategy',
            ],
            outcomes: [
