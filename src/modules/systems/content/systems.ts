    ...
    pillars: [
        {
            ...
            description: 'We build cohesive brand systems that resonate and differentiate. Stop looking like everyone else and start leading your market.',
            capabilities: [
        ...
        },
        {
            ...
            description: 'Robust technical foundations that power your business. From web apps to technical systems, engineered for scale and longevity.',
            capabilities: [
                'Websites & platforms',
        ...
        },
        {
            ...
            description: 'Eliminate repetitive work and connect your stack. Intelligent workflows that save hours daily and let your team focus on growth.',
            capabilities: [
        ...
        },
        {
            ...
            description: 'Marketing infrastructure that runs on autopilot. We build systems that attract, convert, and retain customers predictably.',
            capabilities: [
        ...
        },
        {
            ...
            description: 'High-quality media that fuels your growth engine. Strategic content creation that connects with your audience across every channel.',
            capabilities: [
                'Videography & editing',
                'Content writing',
                'Copywriting',
