                    ...
                    {PARTNERSHIP_BENEFITS.map((benefit, index) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className="group p-6 rounded-2xl bg-linear-to-b from-gray-50 to-white border border-gray-200 hover:border-violet-300 hover:shadow-lg transition-all duration-300"
                            >
                                <div className="w-12 h-12 rounded-xl bg-linear-to-br from-violet-400 to-purple-600 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
